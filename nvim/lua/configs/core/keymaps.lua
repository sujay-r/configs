...
vim.keymap.set("n", "n", 'nzzv', {desc = 'Keep screen centered during next search movement'})
vim.keymap.set("n", "N", 'Nzzv', {desc = 'Keep screen centered during previous search movement'})
